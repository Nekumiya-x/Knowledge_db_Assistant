...
LLM_MODEL_DICT = {
    ...
    "zhipuai": ["chatglm_pro", "chatglm_std", "chatglm_lite","glm-4-0520","glm-4","glm-4-alltools","glm-3-turbo"],
    "Qwen": ["Qwen1.5-0.5B-Chat","Qwen2-0.5B"]
}
EMBEDDING_MODEL_LIST = ['bge-large-zh','zhipuai', 'openai', 'm3e']
INIT_EMBEDDING_MODEL = "bge-large-zh"
...
def respond(message, chat_history, llm, history_len=3, temperature=0.7, max_tokens=2048):
    """
    该函数用于生成机器人的回复。
...
with block as demo:
    with gr.Row(equal_height=True):           
        ...
        with gr.Column(scale=2):
            gr.Markdown("""<h1><center>Chat With LLM</center></h1>
                """)
